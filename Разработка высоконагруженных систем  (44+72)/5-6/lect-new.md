...
Креативный стильный слайд про Fastapi
...
FastAPI
    ...
    ├── Starlette (ASGI, HTTP, WebSockets)
    └── Стандартные типы Python (type hints)
...
| Best For               | Flask, Django (default) | FastAPI, Django-ASGI   |
