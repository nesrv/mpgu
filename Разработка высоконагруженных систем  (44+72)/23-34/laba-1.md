создай на основе Разработка высоконагруженных систем (44+72)\23-34\laba-1.md
веб-методичку (используй весь контент из этого md)

референс 10.OpenSearch_metodichka.html
...
**2.3. Проверить работу сервисов (через wsl) **
```bash
# PostgreSQL
