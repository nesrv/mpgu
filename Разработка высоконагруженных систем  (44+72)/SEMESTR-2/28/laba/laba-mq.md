...
**Часть 1:** разделы **1–2** (вариант 0 и деплой). **Часть 2:** разделы **3–6** и **8** (PostgreSQL, RabbitMQ, шаблоны, проверки, тесты, CI). Подразделы **`3.1`**, **`5.2`** и т.п. относятся к родительскому разделу.
...
### 8.2 Что сдать (дополнительно к отчёту)
