...
- **SFU:** пересылает потоки — меньше нагрузки на **ЦП сервера**, больше на клиентах.
- **MCU:** сводит потоки в одном месте — проще слабым клиентам, **дороже по ресурсам сервера**.
- Выбор зависит от **числа участников и устройств**.

**Подробнее:**

- В крупных звонках иногда **одновременная передача нескольких уровней качества (симулькаст)** — отдельная тема.
