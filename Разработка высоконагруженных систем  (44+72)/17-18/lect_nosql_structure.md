# NoSQL-СУБД: MongoDB и Elasticsearch/OpenSearch в Python (FastAPI)

**Время:** 90 минут  
**Слайдов:** 41  
**Аудитория:** Студенты 4 курса, направление "Информационные системы и технологии"
...
### Блок 5: Заключение (2 мин, слайд 41)

**Слайд 41: Итоги и ресурсы**
